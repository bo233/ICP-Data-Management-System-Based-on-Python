...
class PtMainFrame(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.tId = wx.TextCtrl(self.panel, size=(130, 25), pos=(940, 80), style=wx.TE_READONLY)
        ...
        self.tSymp = wx.TextCtrl(self.panel, size=(240, 100), pos=(940, 420), style=wx.TE_MULTILINE | wx.TE_READONLY)
        self.lDiag = wx.StaticText(self.panel, label='诊断：', pos=(900, 530))
        self.tDiag = wx.TextCtrl(self.panel, size=(240, 100), pos=(940, 530), style=wx.TE_MULTILINE | wx.TE_READONLY)
        ...
        # self.bFront.Disable()
        self.bNext = wx.Button(self.panel, label='后一次', pos=(1040, 700))
        self.bNext.Disable()
        ...
        # 波形图
        self.lTitle = wx.StaticText(self.panel, label='病历系统', pos=(500, 30))
        ...
        self.bModify = wx.Button(self.panel, label='修改信息', pos=(340, 700))
